...
<body>
	<div id="wrapper">
		...
		<div id="contents" >
		<B><font face="맑은 고딕"> 시간표 &nbsp;</font></B>
			
	<INPUT TYPE="BUTTON" VALUE="조회" CLASS="button">
	<BR>
	<BR> <B><font face="맑은 고딕">학년도</font></B>&nbsp;
	<SELECT SIZE="1" NAME="학년도"><OPTION SELECTED>2012</OPTION>
		<OPTION SELECTED>2013</OPTION>
		<OPTION SELECTED>2014</OPTION>
		<OPTION SELECTED>2015</OPTION>
		<OPTION SELECTED>2016</OPTION>
		<OPTION SELECTED>2017</OPTION>
	</SELECT> &nbsp;<B><font face="맑은 고딕">학기</font></B>&nbsp;
	<SELECT SIZE="1" NAME="학기"><OPTION SELECTED>2학기</OPTION>
		<OPTION SELECTED>1학기</OPTION>

	</SELECT> &nbsp; <B><font face="맑은 고딕">주차</font></B>&nbsp;
	<SELECT SIZE="1" NAME="학기"><OPTION SELECTED>1주차</OPTION> &nbsp;
		<OPTION SELECTED>2주차</OPTION>
		<OPTION SELECTED>3주차</OPTION>
		<OPTION SELECTED>4주차</OPTION>
		<OPTION SELECTED>5주차</OPTION>
		<OPTION SELECTED>6주차</OPTION>
		<OPTION SELECTED>7주차</OPTION>
		<OPTION SELECTED>8주차</OPTION>
		<OPTION SELECTED>9주차</OPTION>
		<OPTION SELECTED>10주차</OPTION>
		<p>&nbsp;&nbsp;</p>
		&nbsp;&nbsp;&nbsp;<INPUT TYPE="BUTTON" VALUE="출력" CLASS="button">
	...
	<%
		         ...
		         for(int i=0; i<time.length; i++){
					...
					Query1="SELECT count(*) as count, lecture.titleLecture as titleLecture, lecture.roomLecture as roomLecture, lecture.areaLecture as areaLecture, lecture.profnameLecture as profnameLecture FROM lecture, professor WHERE lecture.Admin_professor_idProf  = professor.idProf AND Admin_professor_idProf="+id+" AND timeLecture LIKE '%/"+(i+1)+"/%' AND daysLecture='"+day[j]+"'";
					//lecture테이블과 professor테이블을  비교해서 시간과 요일 조건에 매칭되는 행을  검색 
