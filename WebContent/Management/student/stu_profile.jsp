...
[class*='btn-'] {
	border-radius: 7px; <%-- Å×µÎ¸® --%> -webkit-box-shadow : inset 0 1px 0
	...
	font-size: 14px;
	margin: 0px 7px 0px 0px; <%-- À§ ¿À¸¥ÂÊ ¾Æ·¡ ¿ÞÂÊ --%> padding : 5px 10px; <%--
	ÀüÃ¼ ³ÐÀÌ --%> text-decoration : none;
	...
	<form name="stu_Profile" METHOD=POST
		...
		<div id="wrapper">
			...
			<div id="contents">
				...
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<INPUT type=SUBMIT VALUE="ÀúÀå" style="text-align: right;"
					class="btn-red1"> <INPUT type=BUTTON VALUE="Á¶È¸"
				...
				<TABLE>
					...
					<TR align=center>
						<td>&nbsp;&nbsp;&nbsp;<b><font face="¸¼Àº °íµñ">ÀÔÇÐÀÏ</font></b>
