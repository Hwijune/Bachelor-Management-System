...
<body>
   ...
   <div class="menu">
      <div id="sidebar">
         <div class="container">
            <ul>
               <li class="dropdown"><a href="#" data-toggle="dropdown">관리내역
                <i class="icon-arrow"></i>
               </a>
                  <ul class="dropdown-menu">
                     <li><a href='../manager/mana_stuProfile.jsp?id=<%=id%>&pw=<%=pw%>'>학생신상 및 등록정정</a></li>
                     <li><a href='../manager/mana_proProfile.jsp?id=<%=id%>&pw=<%=pw%>'>교수신상 및 등록정정</a></li>
                     <%
                     // 학색담당교수 배정내역 x
                     %>
                     <li><a href='../manager/mana_Assignment.jsp?idProf=8301002&id=<%=id%>&pw=<%=pw%>'>담당교수 배정내역</a></li>
                     <li><a href='../manager/mana_confirm_eval.jsp?id=<%=id%>&pw=<%=pw%>&code=1000&title=데이터베이스'>강의평가확인</a></li>
                  </ul></li>
                 </ul>
         </div>
      </div>
